...
data class ExpandasquirtEndpoint(
...
suspend fun discoverExpandasquirt(
    ...
    val deferred = CompletableDeferred<ExpandasquirtEndpoint>()
...
private const val EXPANDASQUIRT_SERVICE_TYPE = "_arduino._tcp."
