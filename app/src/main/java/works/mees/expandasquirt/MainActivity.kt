...
import works.mees.expandasquirt.ui.DashboardScreen
import works.mees.expandasquirt.ui.DashboardViewModel
import works.mees.expandasquirt.ui.DevicePickerScreen
import works.mees.expandasquirt.ui.DiagnosticsScreen
import works.mees.expandasquirt.ui.DiagnosticsViewModel
import works.mees.expandasquirt.ui.HotspotSetupViewModel
import works.mees.expandasquirt.ui.OtaViewModel
import works.mees.expandasquirt.ui.OtaWizardScreen
import works.mees.expandasquirt.ui.PermissionsGate
import works.mees.expandasquirt.ui.UsbRescueScreen
import works.mees.expandasquirt.ui.theme.ExpandasquirtTheme
...
class MainActivity : ComponentActivity() {
    ...
    private val ble by lazy { ExpandasquirtBleClient(applicationContext) }
    @Volatile private var observedBleState = false

    override fun onCreate(savedInstanceState: Bundle?) {
        val splashScreen = installSplashScreen()
        splashScreen.setKeepOnScreenCondition { !observedBleState }
        enableEdgeToEdge()
        super.onCreate(savedInstanceState)
        lifecycleScope.launch {
            ble.state.first()
            observedBleState = true
        }
        setContent {
            ExpandasquirtTheme {
