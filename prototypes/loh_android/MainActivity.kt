/*
 * MainActivity.kt — LOH + OkHttp routing bench prototype for Task 54.
 *
 ...
 *      to the LOH hotspot
 *
 * If all four pass, the production V4X-DESIGN.md OTA approach is unblocked.
 *
...
fun ProtoScreen(appCtx: Context) {
    var status by remember { mutableStateOf("idle — tap Run") }
